...
const IconStatus = () => <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>;
            ...
            <div className="content-wrapper">
                <aside className="sidebar">
                    <div className="premium-card" style={{ padding: '25px', background: 'white' }}>
                        <h3 style={{ fontSize: '1rem', color: 'var(--accent-color)', marginBottom: '10px', display: 'flex', alignItems: 'center', gap: '10px' }}><IconStatus /> STATUS</h3>
                ...
                <aside className="right-sidebar">
                    <div className="premium-card glass" style={{ padding: '25px' }}>
                        <h3 style={{ fontSize: '1rem', color: 'var(--accent-color)', marginBottom: '10px', display: 'flex', alignItems: 'center', gap: '10px' }}><IconLock /> HAVFSIZLIK</h3>
